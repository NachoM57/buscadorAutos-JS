...
function mostrarAutos(autos) {
    ...
    autos.forEach(auto => {
        ...
        const { marca, modelo, year, puertas, transmision, precio, color } = auto; //remplazo el auto. de mas abaj / simplifico sintaxis
...
function llenarSelect() {
    for (let i = max; i >= min; i--) {
        ...
        year.appendChild(opcion); //agrega las opciones de año en el select
    }
}
